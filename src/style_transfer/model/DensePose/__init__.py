...
from style_transfer.densepose import add_densepose_config
from style_transfer.densepose.vis.base import CompoundVisualizer
from style_transfer.densepose.vis.densepose_results import DensePoseResultsFineSegmentationVisualizer
from style_transfer.densepose.vis.extractor import create_extractor, CompoundExtractor
from style_transfer.detectron2.config import get_cfg
from style_transfer.detectron2.data.detection_utils import read_image
from style_transfer.detectron2.engine.defaults import DefaultPredictor


class DensePose:
    """
    DensePose used in this project is from style_transfer.detectron2 (https://github.com/facebookresearch/detectron2).
