...
from style_transfer.detectron2.data.transforms import RandomRotation, RotationTransform, apply_transform_gens
from style_transfer.detectron2.modeling.postprocessing import detector_postprocess
from style_transfer.detectron2.modeling.test_time_augmentation import DatasetMapperTTA, GeneralizedRCNNWithTTA
...
class DensePoseGeneralizedRCNNWithTTA(GeneralizedRCNNWithTTA):
    ...
    # the implementation follows closely the one from style_transfer.detectron2/modeling
