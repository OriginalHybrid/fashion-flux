...
from style_transfer.detectron2.structures import Instances

from style_transfer.densepose.converters.base import IntTupleBox
from style_transfer.densepose.data.utils import get_class_to_mesh_name_mapping
...
class DensePoseCSEBaseSampler(DensePoseBaseSampler):
    """
    Base DensePose sampler to produce DensePose data from style_transfer.densepose predictions.
