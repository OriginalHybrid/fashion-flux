...
from style_transfer.detectron2.structures import BitMasks, Instances

from style_transfer.densepose.converters import ToMaskConverter


class MaskFromDensePoseSampler:
    """
    Produce mask GT from style_transfer.densepose predictions
