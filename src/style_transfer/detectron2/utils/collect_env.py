...
def collect_env_info():
    ...
    try:
        import style_transfer.detectron2  # noqa
    ...
    try:
        import style_transfer.detectron2._C as _C
...
def main() -> None:
    global x
    try:
        from style_transfer.detectron2.utils.collect_env import collect_env_info as f
