def is_nsfw(prompt: str) -> bool:
    nsfw_keywords = [
        "nude", "nudity", "nsfw", "sexual", "explicit", "porn", "erotic",
        "bare", "boobs", "genitals", "naked", "fetish", "intercourse",
        "bdsm", "kissing", "intimate", "provocative", "lewd", "humping", "sex", "coitus", 
        "fuck", "fucking", "dick", "pussy", "masturbation", "topless", "bottomless", "anus",

        "fuck", "shit", "bitch", "dick", "asshole", "bastard", "slut", "cunt",
        "pussy", "fag", "faggot", "whore", "damn", "cock", "tit", "jerk", "wank",
        "nude", "naked", "nsfw", "boobs", "genitals", "penetration", "intercourse", 
        "masturbate", "cum", "orgasm", "anal", "fetish", "bdsm", "lick", "suck", 
        "erotic", "porn", "vagina", "penis", "blowjob", "handjob", "sex", "moan",
        "69", "threesome", "facial", "clit", "dildo", "horny", "kinky", "strip"
    ]
    nsfw_keywords += [
    ...
    "white power", "whore", "worldsex", "wrapping men", "wrinkled starfish", "xx", "xxx", 
    "yaoi", "yellow showers", "yiffy", "zoophilia", "🖕"
]
    nsfw_keywords += [
    "aand", "aandu", "balatkar", "balatkari", "behen chod", "beti chod", "bhadva", "bhadve", "bhandve",
    "bhangi", "bhootni ke", "bhosad", "bhosadi ke", "boobe", "chakke", "chinaal", "chinki", "chod", "chodu",
    "chodu bhagat", "chooche", "choochi", "choope", "choot", "choot ke baal", "chootia", "chootiya",
    "chuche", "chuchi", "chudaap", "chudai khanaa", "chudam chudai", "chude", "chut", "chut ka chuha",
    "chut ka churan", "chut ka mail", "chut ke baal", "chut ke dhakkan", "chut maarli", "chutad", "chutadd",
    "chutan", "chutia", "chutiya", "gaand", "gaandfat", "gaandmasti", "gaandufad", "gandfattu", "gandu",
    "gashti", "gasti", "ghassa", "ghasti", "gucchi", "gucchu", "harami", "haramzade", "hawas",
    "hawas ke pujari", "hijda", "hijra", "jhant", "jhant chaatu", "jhant ka keeda", "jhant ke baal",
    "jhant ke pissu", "jhantu", "kamine", "kaminey", "kanjar", "kutta", "kutta kamina", "kutte ki aulad",
    "kutte ki jat", "kuttiya", "loda", "lodu", "lund", "lund choos", "lund ka bakkal", "lund khajoor",
    "lundtopi", "lundure", "maa ki chut", "maal", "madar chod", "madarchod", "madhavchod", "mooh mein le",
    "mutth", "mutthal", "najayaz", "najayaz aulaad", "najayaz paidaish", "paki", "pataka", "patakha",
    "raand", "randaap", "randi", "randi rona", "saala", "saala kutta", "saali kutti", "saali randi",
    "suar", "suar ke lund", "suar ki aulad", "tatte", "tatti", "teri maa ka bhosada", "teri maa ka boba chusu",
    "teri maa ki behenchod", "teri maa ki chut", "tharak", "tharki", "tu chuda", "asslicking" , "ass licking", "pussylicking", "pussy licking"
    ]
